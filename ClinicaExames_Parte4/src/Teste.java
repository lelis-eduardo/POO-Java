...
//		// ==========================================================================================
		...
		if(c1.adicionaProcedimento(pr9))
			System.out.println("Procedimento adicionado.");
		else
			System.out.println("Não foi possível adicionar o procedimento.");
		...
		System.out.println();
		if(c1.removeProcedimento(pr9))
			System.out.println("Procedimento removido");
		else
			System.out.println("Não foi possível remover o procedimento");
		...
		System.out.println();
		if(a1.adicionaConsulta(c4))
			System.out.println("Consulta adicionada.");
		else
			System.out.println("Não foi possível adicionar a consulta.");
